            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="<?php echo $cfg_baseurl; ?>jadwal.php" class="nav-item nav-link active">Jadwal Matkul</a>
        ...
        <div class="hero" id="home">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="hero-text">
                            <p class="text-center"><u>History education page</u></p>
                            <div class="table-responsive col-lg-12">
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr class="text-uppercase alert alert-danger text-danger">
                                            <th>No</th>
                                            <th>Tingkat</th>
                                            <th>Nama Sekolah</th>
                                            <th>Lulus</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $query_jadwal = mysqli_query($db, "SELECT * FROM history ORDER BY id ASC");
                                        while ($data_history_education = mysqli_fetch_assoc($query_jadwal)) {
                                            ?>
                                            <tr class="text-white bg-danger">
                                                <td><?php echo $data_history_education['id']; ?></td>
                                                <td><?php echo $data_history_education['tingkat']; ?></td>
                                                <td><?php echo $data_history_education['nama_sekolah']; ?></td>
                                                <td><?php echo $data_history_education['tahun_lulus']; ?></td>
                                            </tr>
                                        </tbody>
                                    <?php } ?>
                                </table>
