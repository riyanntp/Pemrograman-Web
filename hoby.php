            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="<?php echo $cfg_baseurl; ?>hoby.php" class="nav-item nav-link active">Hoby</a>
        ...
        <div class="hero" id="home">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="hero-text">
                            <p class="text-center"><u>Hoby page</u></p>
                            <div class="row col-lg-12">
                                <?php
                                $query_hoby = mysqli_query($db, "SELECT * FROM hoby ORDER BY id ASC");
                                while ($data_hoby = mysqli_fetch_assoc($query_hoby)) {
                                ?>
                                <div class="card-body text-center col-lg-4" style="border: 8px;">
                                    <p><?php echo $data_hoby['hoby_name']; ?></p>
                                    <hr>
                                    <small class="text-white"><?php echo $data_hoby['detail_hoby']; ?></small>
                                </div>
                            <?php } ?>
                            </div>
                        </div>
