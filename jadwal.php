        ...
        <div class="hero" id="home">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="hero-text">
                            <p class="text-center"><u>Jadwal page</u></p>
                            <div class="table-responsive col-lg-12">
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr class="text-uppercase alert alert-primary text-primary">
                                            <th>No</th>
                                            <th>Kelas - Matkul</th>
                                            <th>Hari, Waktu Mulai - Waktu Berakhir</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        while ($data_jadwal = mysqli_fetch_assoc($query_jadwal)) {
                                            ...
                                            <tr class="text-white bg-danger">
                                                <td><small><?php echo $data_jadwal['id']; ?></small></td>
                                                <td><small><b><?php echo $data_jadwal['kelas']; ?> - <?php echo $data_jadwal['kode_matkul']; ?></b></small></td>
                                                <td><small><b><?php echo $data_jadwal['date']; ?>, <?php echo $data_jadwal['start_time']; ?> - <?php echo $data_jadwal['end_time']; ?></b></small></td>
                                            </tr>
                                        </tbody>
                                    <?php } ?>
                                </table>
